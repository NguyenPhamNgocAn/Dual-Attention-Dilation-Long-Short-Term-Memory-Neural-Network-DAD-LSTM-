...
iter_loss, valid_error, epoch_loss, best_model= train(model, data, config, n_epochs=1, save_plots=False)
...
print(end - start)
np.save('none_error_darnn.npy',error)
